...
I found a way to add support for multiple user accounts with the classic theme. I will post this change soon.
...
J'ai trouvé un moyen d'ajouter la prise en charge de plusieurs comptes utilisateurs avec le thème classique. Je vais publier ce changement prochainement.
