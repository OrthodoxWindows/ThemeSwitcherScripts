...
echo ************************************************************
echo *              Windows 10 Contraste élevé N°2              *
echo *                                                          *
...
:APPLY
set /P c=Voulez-vous appliquer le thème Windows 10 Contraste élevé N°2 ?[Y\N]?
if /I "%c%" EQU "Y" (call "%userprofile%\TSS\Switcher_Scripts\DWM-Effects_FR.bat"
goto :THM)
if /I "%c%" EQU "N" (goto :ABORT)

:THM
"%userprofile%\TSS\WTS\ThemeSwitcher.exe" "C:\Windows\Resources\Ease of Access Themes\hc2.theme"

start "" /D "%userprofile%\TSS\CTC" "Themes_W10.exe" @appearance /Apply "Win10 - High Contrast #2" "Normal"
