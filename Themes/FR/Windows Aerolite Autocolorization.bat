...
echo ************************************************************
echo *          Windows 10 Aerolite - Autocolorization          *
echo *                                                          *
...
echo * Type de thème : DWM-Effect, style visuel Windows 10 Aerolite (Autocolorization)                              *
echo * Paramètres définis : Il s´agit du thème Aerolite de Windows 10, avec l'application automatique de la couleur *
echo ****************************************************************************************************************
echo.

:APPLY
set /P c=Voulez-vous appliquer le thème Windows 10 Aerolite - Autocolorization ?[Y\N]?
