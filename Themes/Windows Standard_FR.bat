...
if /I "%c%" EQU "Y" (Start %userprofile%\TSS\WTS\ThemeSwitcher.exe "C:\Windows\Resources\Themes\WindowsStandard.theme"
goto :THM)
if /I "%c%" EQU "N" (goto :ABORT)

:THM

%userprofile%\TSS\CTC\Themes_W10.exe @appearance /Apply "Windows Standard" "1-Normal"
