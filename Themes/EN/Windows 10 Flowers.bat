...
echo * Parameters set : This is a theme included by default in Windows 10,      *
echo * with a slideshow of flower images in the background                      *
echo ****************************************************************************
echo.

:APPLY
set /P c=Do you want to apply the Windows 10 - Flowers theme ?[Y\N]?
