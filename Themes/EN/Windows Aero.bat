...
echo * Type de thème : DWM-Effect, Windows 10 Aero Visual Style *
echo * Parameters set : This is the default theme in Windows 10 *
echo ************************************************************
echo.

:APPLY
set /P c=Do you want to apply the Windows 10 Aero theme ?[Y\N]?
