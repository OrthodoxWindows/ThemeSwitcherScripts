...
echo * Theme type : DWM-Effect, Windows 10 Aero Visual Style                                                  *
echo * Parameters set : This is a theme included by default in Windows 10, with light colors on taskbar items *
echo **********************************************************************************************************
echo.

:APPLY
set /P c=Do you want to apply Windows 10 Aero - Light theme ?[Y\N]?
