...
echo * Theme type : DWM-Effect, Windows 10 Aerolite Visual Style (Autocolorization)               *
echo * Parameters set : This is the aerolite theme on Windows 10, with the automatic colorization *
echo **********************************************************************************************
echo.

:APPLY
set /P c=Do you want to apply the Windows 10 Aerolite - Autocolorization theme ?[Y\N]?
