...
if exist "%userprofile%"\tss\Task-Scripts\@UTNC.bat" (echo La composition intégrale dans la zone cliente est déjà activé) else (ren "%userprofile%"\tss\Task-Scripts\@UTNC_old.bat" @UTNC.bat
