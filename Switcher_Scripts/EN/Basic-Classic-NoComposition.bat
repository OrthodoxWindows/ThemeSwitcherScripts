...
if exist "%userprofile%\tss\Task_Scripts\@UT.bat" (echo Composition in client area is already disabled) else (ren "%userprofile%\tss\Task_Scripts\@UT_old.bat" @UT.bat
echo Composition in client area has been disabled)
